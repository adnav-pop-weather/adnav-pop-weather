...
components = {
    ...
    button {
        ...
        onMouseDown = function()
			...
			if(get(tilt88)==1)then	 set(tilt88,0)
			elseif(get(tilt88)==0)then set(tilt88,1)
end
if(get(tilt88)==1)then set(tilt,0)
		end
...
function draw()
	...
	if(get(tilt88)==0)then
		drawText(fontMini,04,17,"T-88",1,1,1,1)
		drawText(fontMini,04,07,"Man",1,1,1,1)
		drawRectangle(2,30,28,28,1,1,1,1)
	elseif(get(tilt88)==1)then 
			drawText(fontMini,04,17,"T-88",0,1,0,1)
			drawText(fontMini,04,07,"88",0,1,0,1)
