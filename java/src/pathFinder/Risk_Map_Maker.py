# previous code worked, but newest installations of conda libraries throw errors.
#   Warning 3: Cannot find header.dxf (GDAL_DATA is not defined)
#   Solution is to point the path of the variables.
import os
...
from shapely import box, voronoi_polygons, MultiPoint, oriented_envelope, Point, LineString  # ensure shapely >= 2.0

import rasterio
from rasterio.plot import show
from rasterio.transform import Affine

import geopandas as gpd  # hidden dependencies pyogrio, pyarrow
